...
(function() {
  ...
  var Dancer = function ( source, codecs ) {
    ...
    //this.source will be source if no codecs passed in
    //just checks codecs passed in
    //ie this.soucce = string http://webdev/three.js/dancer_pulse/assets/Clayhill-Dub.mp3
    this.source = Dancer._makeSupportedPath( source, codecs );
    
    //comes from Dancer._getAdapter
    this.audioAdapter.load( this.source );
    //this.audioAdapter.load( track );
  };
...
//
      ...
      req.onload = function () {
        //console.log(this);
        //this = ajax object XMLHttpRequest
        //
      ...
      req.send();
      //xmlhttprequest trying to get local file
      //GET http://webdev/three.js/dancer_pulse/[object%20Object] 404 (Not Found) 
